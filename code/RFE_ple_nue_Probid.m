...
probidData = class_n';                  %10 by 219727 matrix
...
load 'healthy controls_subj1_neu';
probidData = [probidData;class_n'];

load 'healthy controls_subj2_neu';
probidData = [probidData;class_n'];

load 'healthy controls_subj3_neu';
probidData = [probidData;class_n'];

load 'healthy controls_subj4_neu';
probidData = [probidData;class_n'];

load 'healthy controls_subj5_neu';
probidData = [probidData;class_n'];
...
for r=1:10
    ...
    if r~=1
        ...
        probidData(:,IndexOfFeatsToRemoved(end-((size(probidData,2))*.32)+1:end))=[];
